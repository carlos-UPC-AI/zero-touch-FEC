...
from config import (
    ENV_SMALL, BACKGROUND_VEHICLES, SAVE_FREQ,
...
ENVIRONMENT = Environment(scenario=ENV_SMALL['scenario'],
                          edges_cost=ENV_SMALL['edges_cost'],
                          network=ENV_SMALL['network'],
                          fec_coverage=ENV_SMALL['fec_coverage'],
                          state_features=ENV_SMALL['state_features'],
                          no_up_nodes=ENV_SMALL['no_up_nodes'],
                          no_down_nodes=ENV_SMALL['no_down_nodes'],
                          no_left_nodes=ENV_SMALL['no_left_nodes'],
                          no_right_nodes=ENV_SMALL['no_right_nodes'],
                          nodes=ENV_SMALL['nodes'],
